...
public class RentalsController : ControllerBase
{
    ...
    /// </summary>
    [HttpPut("{id}/return")]
    [ProducesResponseType(typeof(ReturnRental.ReturnRentalResult), StatusCodes.Status200OK)]
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<ActionResult<ReturnRental.ReturnRentalResult>> Return(Guid id, [FromBody] ReturnRentalRequest request)
    {
        try
        {
